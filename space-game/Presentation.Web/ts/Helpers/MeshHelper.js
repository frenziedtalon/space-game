...
class MeshHelper {
    ...
    getMeshBoundingSphereRadius(mesh) {
    ...
    pickMesh(evt, scene) {
        ...
        const pickResult = scene.pick(evt.clientX, evt.clientY, null, false, this.cameraHelper.getViewportCamera(clientPoint, scene.activeCameras));
